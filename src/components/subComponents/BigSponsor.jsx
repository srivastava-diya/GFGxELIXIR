            ...
            >
              ...
              <Card className="relative overflow-hidden border-none bg-gradient-to-b from-white/[0.08] to-transparent backdrop-blur-xl rounded-none transition-all duration-500 group-hover:from-white/[0.12]">
                <CardContent className="p-12 flex flex-col items-center justify-center min-h-[320px]">
                  ...
                  <div className="absolute z-10 w-40 h-24 mb-10 transition-transform duration-500 group-hover:scale-110 group-hover:-translate-y-2">
                    {sponsorsData.image ? (
                      <Image
                        fill
                        src={sponsor.image}
                      ...
                      <div className="w-full h-full flex items-center justify-center border border-dashed border-white/20 uppercase text-[10px] tracking-widest text-white/40">{sponsor.alt}</div>
                    )}
                  </div>
